...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.search, 1, 3, 1, 1)
        self.searchEdit = QtWidgets.QLineEdit(self.centralwidget)
        self.searchEdit.setObjectName("searchEdit")
        self.gridLayout.addWidget(self.searchEdit, 1, 2, 1, 1)
        self.type = QtWidgets.QComboBox(self.centralwidget)
        self.type.setObjectName("type")
        self.type.addItem("")
        self.type.addItem("")
        self.type.addItem("")
        self.gridLayout.addWidget(self.type, 1, 4, 1, 1)
        self.mapImage = QtWidgets.QLabel(self.centralwidget)
        self.mapImage.setFocusPolicy(QtCore.Qt.ClickFocus)
        self.mapImage.setText("")
        self.mapImage.setObjectName("mapImage")
        self.gridLayout.addWidget(self.mapImage, 2, 1, 1, 4)
